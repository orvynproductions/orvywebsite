...
export const productShowcaseConfig: ProductShowcaseConfig = {
  ...
  products: [
    ...
    },
    {
      ...
      price: "₹150",
      image: "/images/packchoy.png",
      filter: "",
      glowColor: "bg-green-300/20",
      description: "Crunchy Asian greens with mild flavor, perfect for stir-fries and salads.",
...
export const shopConfig: ShopConfig = {
  ...
  },
  {
    ...
    category: "Microgreens",
    inStock: true,
    nutritionHighlights: ["Iron", "Fiber", "Digestive Support"],
  },
  {
    id: "onion-chives-50g",
    name: "Onion Chives",
  ...
  },
{
  id: "spinach-50g",
  name: "Spinach Microgreens",
  description: "Soft, mild greens perfect for daily nutrition and salads",
  price: 98,
  unit: "50g",
  image: "/images/spinach.png",
  category: "Microgreens",
  inStock: true,
  nutritionHighlights: ["Vitamin K", "Folate", "Antioxidants"],
},
{
  id: "pak-choy-50g",
  name: "Pak Choy",
  description: "Crunchy Asian greens ideal for stir-fries and salads",
  price: 150,
  unit: "50g",
  image: "/images/packchoy.png",
  category: "Microgreens",
  inStock: true,
  nutritionHighlights: ["Calcium", "Vitamin C", "Fiber"],
},
{
  id: "edible-flowers-50g",
  name: "Edible Flowers",
  description: "Colorful premium garnish for gourmet dishes and desserts",
  price: 284,
  unit: "50g",
  image: "/images/edibleflr.png",
  category: "Garnish",
  inStock: true,
  nutritionHighlights: ["Natural Colors", "Antioxidants", "Gourmet Garnish"],
},
{
  id: "garlic-50g",
  name: "Garlic Chives",
  ...
  category: "Microgreens",
  inStock: true,
  nutritionHighlights: ["Allicin", "Antioxidants", "Immunity Support"],
},
  ],
};
