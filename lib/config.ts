...
export const productShowcaseConfig: ProductShowcaseConfig = {
  ...
  features: [
    {
      icon: "Leaf",
      title: "100% Organic",
      description: "Certified organic growing practices with no pesticides or synthetic fertilizers ever used.",
    },
    {
      icon: "Clock",
      title: "Harvested Fresh",
      description: "Cut to order and delivered within 24 hours for maximum freshness and nutrition.",
    },
    {
      icon: "Heart",
  ...
  quote: {
    text: "Adding microgreens to our dishes has elevated our cuisine to a whole new level. The freshness and flavor are unmatched.",
    attribution: "Chef Marcus Chen, The Garden Table",
    prefix: "Chef's Choice",
  },
};
...
export const facilityCarouselConfig: FacilityCarouselConfig = {
  ...
  locationTag: "Portland, Oregon",
  slides: [
    {
      image: "/images/growing-room.jpg",
      title: "Climate-Controlled",
      title2: "Growing Rooms",
      area: "5,000",
      unit: "sq ft",
      description: "Our indoor vertical farm features precise climate control, LED grow lights, and automated irrigation systems for optimal growing conditions year-round.",
    },
    {
    ...
    },
    {
      ...
      area: "100%",
      unit: "compostable",
      description: "We use eco-friendly, compostable packaging to keep your greens fresh while minimizing environmental impact. Zero waste is our goal.",
    },
  ],
};
...
export const aboutConfig: AboutConfig = {
  ...
  timeline: [
    { year: "2020", event: "Started in a small garage with 20 trays" },
    { year: "2021", event: "First restaurant partnership signed" },
    { year: "2022", event: "Expanded to 2,000 sq ft facility" },
    { year: "2023", event: "Launched home delivery service" },
  ...
  tabs: [
    ...
    },
    {
      ...
      content: {
        ...
        description: "We maintain the highest quality standards with regular testing, strict sanitation protocols, and complete traceability from seed to package. Your safety and satisfaction are our priorities.",
        highlight: "Certified • Tested • Trusted",
      },
    },
  ],
  ...
  quote: {
    ...
    attribution: "Sarah & Mike Johnson, Founders",
  },
  founderPhotoAlt: "Sarah and Mike Johnson, founders of Orvyn Productions",
...
export const benefitsConfig: BenefitsConfig = {
  ...
  testimonials: [
    ...
    },
    {
      name: "Lisa Martinez",
      role: "Nutritionist",
      text: "I recommend microgreens to all my clients. They're the easiest way to boost nutrient intake without changing your whole diet.",
      rating: 5,
    },
  ],
  ...
  storyParagraphs: [
    "Since 2020, we've grown more than just microgreens—we've grown a community of health-conscious individuals who care about where their food comes from.",
  ...
  storyTimeline: [
    { value: "50K+", label: "Trays Harvested" },
  ...
  storyQuote: {
    prefix: "Join Us",
    text: "Every purchase supports sustainable urban farming and brings fresh, nutritious food to our community.",
...
export const footerConfig: FooterConfig = {
  ...
  socialLinks: [
    { icon: "Instagram", label: "Instagram", href: "https://instagram.com/greensprout" },
    { icon: "Facebook", label: "Facebook", href: "https://facebook.com/greensprout" },
    { icon: "Twitter", label: "Twitter", href: "https://twitter.com/greensprout" },
  ],
  linkGroups: [
    {
      title: "Quick Links",
  ...
  contactItems: [
    {
      icon: "MapPin",
      text: "1234 Green Valley Rd, Portland, OR",
